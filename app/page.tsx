      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 mb-10 max-w-2xl mx-auto">
            Une simulation propulsée par l’IA où des souris virtuelles trouvent leur chemin
            à travers des labyrinthes complexes.
          </p>
          <Link
            href="/simulate"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Découvrez ce qui fait de Souris IA l’outil idéal pour explorer les algorithmes de navigation.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center p-6 rounded-xl bg-gray-50 transition-colors duration-200">
              ...
              <h4 className="text-xl font-semibold text-gray-900 mb-3">Navigation IA</h4>
            ...
            <div className="text-center p-6 rounded-xl bg-gray-50 transition-colors duration-200">
              ...
              <h4 className="text-xl font-semibold text-gray-900 mb-3">Labyrinthes personnalisés</h4>
            ...
            <div className="text-center p-6 rounded-xl bg-gray-50 transition-colors duration-200">
              ...
              <h4 className="text-xl font-semibold text-gray-900 mb-3">Simulation temps réel</h4>
              <p className="text-gray-600">Visualisation fluide des déplacements et suivi de la santé/moral.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 mb-4 md:mb-0">© 2025 Souris IA. Tous droits réservés.</p>
            <a
